               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <?php
                        if ($invoice->layanan_pesanan == "Pick Up") {
                            echo '<div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Kurir</b><span class="flex items-center ml-auto"> Kurir EasyPickTrash</span></div>';
                        } else {
                            echo '<div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Pengiriman</b><span class="flex items-center ml-auto"> Antar Sendiri</span></div>';
                        }
                   ?>
