    ...
    <div class="intro-y grid grid-cols-12 gap-5 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="grid grid-cols-12 gap-5 mt-5 pt-5 border-t">
                ...
                <a href="<?php echo base_url('dashboard_categories/' . $row->kategori) ?>" data-tw-toggle="modal"
                    data-tw-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 2xl:col-span-3">
