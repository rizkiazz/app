           ...
           <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
               <div class="box p-5 rounded-md">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Nama Produk :</b> <a href="" class="underline decoration-dotted ml-1">
                           <?= $row->nama_brg ?></a>
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="info" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Deskripsi: &nbsp;</b>
                       <?= $row->keterangan ?>
                   </div>
               </div>
                               ...
                               <tr>
                                   <td class="!py-4">
                                       <div class="flex items-center">
                                           <img src="<?= base_url() . '/uploads/produk/' . $row->gambar ?>"
                                               width="40px">
                                           <a href=""
                                               class="font-medium whitespace-nowrap ml-4"><?= $row->nama_brg ?></a>
                                       </div>
                                   </td>
                                   <td><?= number_format($row->poin, 0, ',', '.') ?> Poin</td>
                                   <td><?= number_format($row->harga, 0, ',', '.') ?> /kg,-</td>
                                   <td><?= $row->kategori ?></td>
                               </tr>
                           </tbody>
                       </table>
