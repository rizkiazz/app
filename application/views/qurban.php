        ...
        <div class="intro-y flex-1 px-5 py-5">
            ...
            <div class="flex justify-center">
                <div class="relative mx-auto mt-8 text-5xl font-semibold">
                    <span class="absolute top-0 left-0 -ml-4 text-2xl">$</span>250 Juta++ Poin
                </div>
            </div>
            <div class="mx-auto mt-2 py-10 text-center text-xl text-slate-500 font-semibold">
                Donasi terkumpul untuk Qurban di EasyPickTrash selama
                2 tahun terakhir
            </div>
            ...
            <div class="mx-auto mt-5 px-10 text-center text-slate-500 font-medium">
                ...
                Sudah tahu mau cara berqurban Secara online? Tahun ini, EasyPickTrash kembali meluncurkan platform
                qurban
                online. Sebagai wadah yang membantu masyarakat Indonesia menyalurkan kebaikan, kini
                EasyPickTrash lebih dari sekedar platform donasi. Kamu juga bisa menyalurkan qurban di lebaran Idul
                Adha Tahun ini melalui EasyPickTrash
            </div>
