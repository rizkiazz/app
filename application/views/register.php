        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">Beberapa langkah lagi untuk masuk ke akun Anda.</div>
                    <form action="<?= site_url('register') ?>" method="post">
                        <div class="intro-x mt-8">
                            ...
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Sandi" name="password_1" autocomplete="off">
                            ...
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Konfirmasi Sandi" name="password_2" autocomplete="off">
                        </div>
