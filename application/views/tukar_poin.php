<div class="content">
    ...
    <div class="mt-5 grid grid-cols-12 gap-5 border-t pt-5">
        <a class="intro-y col-span-12 block sm:col-span-4 2xl:col-span-3" data-tw-toggle="modal"
            data-tw-target="#add-item-modal" href="<?= site_url('/tukar_poin/dana') ?>">
        ...
        <a class="intro-y col-span-12 block sm:col-span-4 2xl:col-span-3" data-tw-toggle="modal"
            data-tw-target="#add-item-modal" href="<?= site_url('/tukar_poin/shopee_pay') ?>">
            <div class="box zoom-in relative rounded-md p-3">
                <div class="relative block flex-none before:block before:w-full before:pt-[100%]">
                    <div class="image-fit absolute top-0 left-0 h-full w-full">
                        <img class="rounded-md"
                            src="https://static.vecteezy.com/system/resources/previews/013/109/756/original/shopee-element-symbol-shopeepay-shopeepay-icon-free-vector.jpg"
                            alt="Shopee Pay">
                    </div>
                </div>
                <div class="mt-3 block truncate text-center font-medium">
    ...
    <div class="mt-5 grid grid-cols-12 gap-5 border-t pt-5">
        <a class="intro-y col-span-12 block sm:col-span-4 2xl:col-span-3" data-tw-toggle="modal"
            data-tw-target="#add-item-modal" href="<?= site_url('/tukar_poin/qurban') ?>">
            <div class="box zoom-in relative rounded-md p-3">
                <div class="relative block flex-none before:block before:w-full before:pt-[100%]">
                    <div class="image-fit absolute top-0 left-0 h-full w-full">
                        <img class="rounded-md" src="https://pantiyatim.or.id/wp-content/uploads/2022/06/qurban.png"
                            alt="Qurban">
                    </div>
                </div>
                <div class="mt-3 block truncate text-center font-medium">
        ...
        <a class="intro-y col-span-12 block sm:col-span-4 2xl:col-span-3" data-tw-toggle="modal"
            data-tw-target="#add-item-modal" href="<?= site_url('/tukar_poin/galang_dana_pembangunan') ?>">
            <div class="box zoom-in relative rounded-md p-3">
                <div class="relative block flex-none before:block before:w-full before:pt-[100%]">
                    <div class="image-fit absolute top-0 left-0 h-full w-full">
                        <img class="rounded-md"
